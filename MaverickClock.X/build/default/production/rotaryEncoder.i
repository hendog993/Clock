...
# 26 "rotaryEncoder.c" 2



static volatile RotaryEncoder * rot;
static _Bool isRotaryEncoderEnabled = 0;
...
void RotaryEncoder_Enable( void )
{
    ...
    rot->rotBtn.hasSwitchBeenPressed = 0;

    TMR3_StartTimer( );
    isRotaryEncoderEnabled = 1;
}

void RotaryEncoder_Disable( void )
{
    TMR3_StopTimer( );
    isRotaryEncoderEnabled = 0;
}
...
static void RotaryEncoder_ReadShaftISR( void )
{
    if( isRotaryEncoderEnabled )
    {
        ...
        rot->shaft.vector |= ( PORTCbits.RC4 ) ? 0x2u : 0x0u;
        rot->shaft.vector |= ( PORTCbits.RC3 ) ? 0x1u : 0x0u;
    ...
    if( 1 == isRotaryEncoderEnabled )
    {
        ...
        switch( PORTCbits.RC5 )
        {
            ...
            case 0x00:
                ...
                rot->rotBtn.hasSwitchBeenPressed = 1;
