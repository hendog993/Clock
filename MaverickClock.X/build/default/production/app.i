...
# 5 "C:/Users/henry/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.6.143/xc8\\pic\\include\\builtins.h" 2 3
...
typedef struct
{
    _Bool isRotaryEncoderValid;
    _Bool isLEDSetupValid;
    _Bool isLEDWriteValid;
} ApplicationStatus;
...
static RotaryEncoder rot = {
    .rotBtn.config.multiClickTimerThreshold_cts = 0x54D,
    .rotBtn.config.longPressTimerThreshold_cts = 0x1E48,
    .rotBtn.config.multiClickTimeFreshnessLimit_cts = 0xF24,
};
...
void APP_TASKS( void )
{
    static _Bool wasSwitchPressedInTimeMode = 0;
