...
# 39 "clockLEDs.c" 2
# 56 "clockLEDs.c"
static __pack ws2812bPixel renderBuffer [64];
static ws2812bArray ledArray;
...
static uint8_t currentDIGITrgbArray[3u];
static uint8_t currentBACKGROUNDrgbArray[3u];
# 84 "clockLEDs.c"
static __pack ws2812bPixel upEncodedDigitsPixelValues[10u][14u];
static __pack ws2812bPixel downEncodedDigitsPixelValues[10u][14u];
# 96 "clockLEDs.c"
static const uint16_t upDigitEncodings[10u] = {
    0b1101110001010100,
    0b0000010101010100,
    0b1110110101000100,
    0b1010110101010100,
...
static const uint16_t downDigitEncodings[10u] = {
    0b1101110001010100,
    0b0000010101010100,
    0b1011110101010000,
    0b1010110101010100,
...
void Clock_WriteTimeDigitValuesAndRenderScreen( const TimeInDigits * const digits )
{
    static uint8_t lastDigit1 = 0xFF;
...
void Clock_PrerenderPixelAndBackgroundValues( void )
{
    ...
    WS2812b_SetStripConstantColor( &ledArray,
                                   currentBACKGROUNDrgbArray[0u],
                                   currentBACKGROUNDrgbArray[1u],
                                   currentBACKGROUNDrgbArray[2u] );
                                                          ...
                                                          const uint16_t * encodingSource )
{
    ...
    for( digitCounter = 0; digitCounter < 10u; digitCounter++ )
    {
        for( encodingCounter = 0; encodingCounter < 14u; encodingCounter++ )
        {

            if( ( *encodingSource << encodingCounter ) & 0x8000u )
            {
                memcpy( thisDigitStartAddress, currentDIGITrgbArray, 3u );
            }
            else
            {
                memcpy( thisDigitStartAddress, currentBACKGROUNDrgbArray, 3u );
            }
            thisDigitStartAddress += 3u;
        }
        encodingSource++;
    }
}
...
void Clock_CrossingRainbowPattern( )
{
    ...
    {
        thisIndex = 0;
        rainbowRowIdx = ( 5 == rainbowRowIdx ) ? 0 : rainbowRowIdx + 1;
    }
    else
    {
        thisIndex++;
...
void Clock_CrossingRainbowPatternwithDelays( )
{
    ...
    WS2812B_Render( &ledArray );
    _delay((unsigned long)((75)*(32000000u/4000.0)));
    return;
}
...
void Clock_Popcorn_Pattern( void )
{
    ...
    WS2812b_SetSinglePixelColor( &ledArray,
                                 ...
                                 ( rand( ) % 255 ) );
    WS2812B_Render( &ledArray );
    _delay((unsigned long)((150)*(32000000u/4000.0)));
}
